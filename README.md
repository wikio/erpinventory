...
IndexedDB schema version 12 now includes 63 offline stores. It adds centrally managed VAT rates, ERP-wide configurable reference masks and sequence counters, employee career records, conversations, and messages; all are included in JSON backups.
...
Version 12 adds an explicit header toggle for inline translation mode, double-click translation editing, a persisted rendered-text coverage report, multilingual dynamic entity fields, fully translated sidebar/footer/stock screens, configurable translated options, and CRUD GED types/categories/modules/tags with card/list browsing and document previews. It retains dedicated document details, payments, all 250 ISO countries, audit diffs, detailed PDF reports, bank dashboards, visual and sandboxed HTML templates, fixed-size multipage PDF headers, print QA, master data, workflows, bulk imports, and the authenticated public API.
