...
IndexedDB schema version 11 now includes 62 offline stores. It adds centrally managed VAT rates, ERP-wide configurable reference masks and sequence counters, employee career records, conversations, and messages; all are included in JSON backups.
...
Version 11 adds in-context hover translation for static and data-driven content, multilingual product/document/mission fields, fully translated sidebar/footer/stock screens, configurable GED categories/modules/tags, configurable translated option lists, and card/list GED browsing with detailed previews. It retains dedicated partner-linked document details, payment histories, all 250 ISO countries, reference-list translation management, structured audit diffs, detailed PDF reports, bank dashboards, visual and sandboxed HTML templates, version rollback, fixed-size multipage PDF headers, print QA, configurable master data, workflows, bulk imports, and the authenticated public API.
