...
class SariDB {
  constructor(dbName = 'SariSystemeDB', version = 12) {
    this.dbName = dbName;
    ...
    this.initPromise = new Promise((resolve, reject) => {
      ...
      request.onupgradeneeded = (event) => {
        ...
        const stores = [
          ...
          'entityTranslations', 'gedCategories', 'gedModules', 'gedTags', 'gedTypes', 'configurableOptions'
        ];
  ...
  async exportJSON() {
    ...
    const stores = [
      ...
      'productLots', 'stockMovements', 'inventoryCounts', 'importProfiles', 'apiTokens', 'apiEndpoints', 'logisticsStatuses', 'incoterms', 'paymentTransactions', 'reportAnnotations', 'entityTranslations', 'gedCategories', 'gedModules', 'gedTags', 'gedTypes', 'configurableOptions'
    ];
    const exportData = {
