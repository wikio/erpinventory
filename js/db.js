...
class SariDB {
  ...
  referenceOrderStores(){return new Set(['products','suppliers','banks','bankAccounts','customers','shipments','tenders','orders','purchaseDocuments','jobPostings','employees','missions','documentTemplates','taxRecords','stockMovements','inventoryCounts','paymentTransactions']);}
