...
class SariDB {
  constructor(dbName = 'SariSystemeDB', version = 17) {
    this.dbName = dbName;
    ...
    this.initPromise = new Promise((resolve, reject) => {
      ...
      request.onupgradeneeded = (event) => {
        ...
        const stores = [
          ...
          'cnasDeclarations', 'cnasPayments', 'casnosDeclarations', 'casnosPayments', 'shareholders', 'shareholderHistory', 'companyRegisters', 'socialAccounts', 'companyMinutes', 'tradeRegisters', 'tradeRegisterHistory', 'commerceRequests'
        ];
  ...
  async exportJSON() {
    ...
    const stores = [
      ...
      'productLots', 'stockMovements', 'inventoryCounts', 'importProfiles', 'apiTokens', 'apiEndpoints', 'logisticsStatuses', 'incoterms', 'paymentTransactions', 'reportAnnotations', 'entityTranslations', 'translationTexts', 'gedCategories', 'gedModules', 'gedTags', 'gedTypes', 'configurableOptions', 'userProfiles', 'barcodeLabelSettings', 'cnasDeclarations', 'cnasPayments', 'casnosDeclarations', 'casnosPayments', 'shareholders', 'shareholderHistory', 'companyRegisters', 'socialAccounts', 'companyMinutes', 'tradeRegisters', 'tradeRegisterHistory', 'commerceRequests'
    ];
    const exportData = {
