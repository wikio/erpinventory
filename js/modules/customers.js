...
const CustomersModule = {
  ...
  async render(containerId = 'sari-main-view') {
    ...
    [this.state.orders,this.state.purchaseDocuments,this.state.clientTypes] = await Promise.all(['orders','purchaseDocuments','clientTypes'].map(s=>sariDB.getAll(s)));
