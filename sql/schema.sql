...
CREATE TABLE `user_profiles` (`id` VARCHAR(64) PRIMARY KEY, `user_id` VARCHAR(64) UNIQUE NOT NULL, `display_name` VARCHAR(150), `email` VARCHAR(150), `phone` VARCHAR(50), `address` VARCHAR(255), `photo_data` LONGTEXT, `updated_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (`user_id`) REFERENCES `users` (`id`));
...
CREATE TABLE `ged_types` (`id` VARCHAR(64) PRIMARY KEY, `code` VARCHAR(64), `name_json` JSON NOT NULL, `sort_order` INT DEFAULT 0, `is_active` BOOLEAN DEFAULT TRUE);
