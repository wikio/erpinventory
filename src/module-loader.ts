...
const loaders: Record<string, () => Promise<LegacyModule>> = {
  ...
  leaves: async () => { await complianceShared(); return importModule(() => import('../js/modules/leaves.js'), 'LeaveModule'); },
  contracts: async () => { await complianceShared(); return importModule(() => import('../js/modules/contracts.js'), 'ContractsModule'); },
  occasionalWorkers: async () => { await complianceShared(); return importModule(() => import('../js/modules/occasional-workers.js'), 'OccasionalWorkersModule'); },
