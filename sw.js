const CACHE_NAME = 'sari-systeme-v2.1.0-numeric-external-db';
const ASSETS_TO_CACHE = [
  ...
  '/js/i18n.js',
  '/js/translation-overlay.js',
  '/js/translation-coverage.js',
  '/js/option-catalog.js',
  '/js/auth.js',
  '/js/sync.js',
  '/js/charts.js',
  '/js/utils.js',
  ...
  '/js/modules/api.js',
  '/js/modules/document-detail.js',
  '/js/modules/bank-account-detail.js',
  '/js/app.js'
];
